...
var _origOpen=window.openModal;if(typeof _origOpen==='function'){window.openModal=function(id){var el=document.getElementById(id);if(el)el.style.display='';_origOpen(id);setTimeout(function(){fixModalFooter();fixModalScroll();if(id==='modal-addPR')fixPRRequester();if(id==='modal-addSupInv')_injectScanBtn('modal-addSupInv','scan-supinv-btn','สแกนใบแจ้งหนี้',window.scanSupInv);},80);};}
