...
async function _ssRenderSection(container, patientId, pid, fromDate, toDate) {
  ...
  keys.forEach(function(k) {
    ...
    // ── Actions ──
    // [Step B-7 · 20 พ.ค. 69] เก็บแค่ดู/พิมพ์/PDF/แก้ไข/regenerate
    // ปุ่ม handover (ปิด/รับ/เปิดใหม่/ขอเปิด/อนุมัติ/ปฏิเสธ) ย้ายไปหน้ารวมผู้รับบริการแล้ว
    ...
    if (!isClosed) {
      // เปิดอยู่ — ให้แก้ + regenerate (ถ้า manual) แต่ไม่ให้ปิดเวรจากที่นี่
