...
var BOTTOM_TAB_META = {
  ...
  patients:         { icon: '🏥', label: 'ผู้รับบริการ' },
  stock:            { icon: '📦', label: 'คลังสต็อก' },
  billing:          { icon: '💰', label: 'ระบบบัญชี' },
  requisition:      { icon: '📋', label: 'เบิกสินค้า' },
  history:          { icon: '🕐', label: 'รายละเอียดการเบิก' },
  rooms:            { icon: '🛏️', label: 'ห้องและเตียง' },
  staff:            { icon: '👤', label: 'พนักงาน' },
  dietary:          { icon: '🍽️', label: 'โภชนา' },
  incident:         { icon: '⚠️', label: 'อุบัติเหตุ' },
  deposits:         { icon: '🏦', label: 'มัดจำ & เงินประกัน' },
  assets:           { icon: '🔧', label: 'ครุภัณฑ์ฯ' },
  expenses:         { icon: '💸', label: 'ค่าใช้จ่าย' },
  report:           { icon: '📈', label: 'สรุปวิเคราะห์การเบิก' },
  healthreport:     { icon: '📋', label: 'รายงานสุขภาพ' },
  suppliers:        { icon: '🏭', label: 'ผู้จำหน่าย' },
  purchasehistory:  { icon: '📜', label: 'ซื้อ' },
  purchaserequests: { icon: '📋', label: 'คำขอซื้อ' },
  supplierinvoices: { icon: '🧾', label: 'ใบแจ้งหนี้ผู้จำหน่าย' },
  stockreport:      { icon: '📊', label: 'รายงานสต็อก' },
  accounts:         { icon: '🔑', label: 'จัดการ Account' },
  audit:            { icon: '🔍', label: 'Audit Trail' },
  bi:               { icon: '🔍', label: 'BI' },
  settings:         { icon: '💬', label: 'Line & ตั้งค่า' },
